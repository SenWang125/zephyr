...
#. To check that you have set these variables correctly in your current
   ...
   .. code-block:: console
      ...
      /home/you/ti/ti-cgt-c7000_5.0.1.LTS

   .. code-block:: batch

      # Windows
      set ZEPHYR_TOOLCHAIN_VARIANT=cl7x
      set CL7X_TOOLCHAIN_PATH=C:\ti\ti-cgt-c7000_5.0.1.LTS
      echo %CL7X_TOOLCHAIN_PATH%
...
Additional limitations, all verified against CGT 5.0.1:
...
* no ``--gc-sections`` equivalent, which is why the toolchain retains entry
  points explicitly,
* 5.0.1 is the minimum; the build refuses anything older.
