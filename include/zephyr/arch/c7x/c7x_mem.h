 ...
 *
 * One flag per attribute index: K_MEM_CACHE_WB is MAIR7, WT is MAIR6,
 * NONE is MAIR0, and the flags below name the other five.
 */
#ifndef ZEPHYR_INCLUDE_ARCH_C7X_C7X_MEM_H_
#define ZEPHYR_INCLUDE_ARCH_C7X_C7X_MEM_H_

/** Device memory, nGnRnE (MAIR0), the value K_MEM_CACHE_NONE carries */
