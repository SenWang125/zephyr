...
#define C7X_MMU_POOL_ENTRIES	(C7X_MMU_POOL_TABLES * C7X_MMU_ENTRIES)
...
#define C7X_TCR_OUTER_SHAREABLE	((uint64_t)1 << 10)
#define C7X_TCR_INNER_CACHEABLE	((uint64_t)1 << 11)
#define C7X_TCR_OUTER_CACHEABLE	((uint64_t)1 << 13)
#define C7X_TCR_MEMTYPE_CACHEABLE ((uint64_t)1 << 15)
...
void z_c7x_mmu_mair_set(unsigned int index, unsigned int value);
void z_c7x_mmu_tcr_set(uint64_t tcr);
void z_c7x_mmu_tbr0_set(uint64_t *table);
void z_c7x_mmu_tlb_inv(uint64_t val);
