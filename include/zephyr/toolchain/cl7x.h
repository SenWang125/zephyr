 ...
 *  accepted except optimize("..."), fallthrough and optnone.
 */
...
/* name stays a function for the linker force-reference; the offsets are file-scope */
...
#define __Z_LOG2_2(x)  (((x) >= (1ULL << 1)) ? 1 : 0)
#define __Z_LOG2_4(x)  (((x) >= (1ULL << 2)) ? (2 + __Z_LOG2_2((x) >> 2)) : __Z_LOG2_2(x))
#define __Z_LOG2_8(x)  (((x) >= (1ULL << 4)) ? (4 + __Z_LOG2_4((x) >> 4)) : __Z_LOG2_4(x))
#define __Z_LOG2_16(x) (((x) >= (1ULL << 8)) ? (8 + __Z_LOG2_8((x) >> 8)) : __Z_LOG2_8(x))
#define __Z_LOG2_32(x) (((x) >= (1ULL << 16)) ? (16 + __Z_LOG2_16((x) >> 16)) : __Z_LOG2_16(x))
#define __Z_LOG2_64(x) (((x) >= (1ULL << 32)) ? (32 + __Z_LOG2_32((x) >> 32)) : __Z_LOG2_32(x))

/* A constant folds to an integer constant expression, as it does with GCC. */
#define __builtin_clz(x) \
	(__builtin_constant_p(x) ? (31 - __Z_LOG2_32((unsigned int)(x))) \
				  : __cl7x_clz((unsigned int)(x)))
...
#define __builtin_clzll(x) \
	(__builtin_constant_p(x) ? (63 - __Z_LOG2_64((unsigned long long)(x))) \
				  : __cl7x_clzll((unsigned long long)(x)))
