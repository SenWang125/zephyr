...
extern FUNC_NORETURN void z_c7x_fatal_error(unsigned int reason,
...
void z_c7x_switch(void *switch_to, void **switched_from);

static ALWAYS_INLINE void arch_switch(void *switch_to, void **switched_from)
{
	z_c7x_switch(switch_to, switched_from);
}
...
void z_c7x_thread_start(void);
FUNC_NORETURN void z_c7x_exit_secure(uint64_t tsr, uint64_t target);
extern uint64_t z_c7x_isr_task_sp[2];

extern char z_c7x_ecsp_area[];
extern char z_c7x_tcsp_area[];
extern char z_c7x_isr_stack[];
