...
extern char z_c7x_isr_stack[CONFIG_ISR_STACK_SIZE];
...
ZTEST(c7x_core, test_isr_runs_on_isr_stack)
{
	...
	zassert_true(rt_isr_sp >= (uintptr_t)z_c7x_isr_stack &&
		     rt_isr_sp < (uintptr_t)z_c7x_isr_stack + CONFIG_ISR_STACK_SIZE,
